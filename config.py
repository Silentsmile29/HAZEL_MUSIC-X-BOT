...
BOT_USERNAME = getenv("BOT_USERNAME" , "Silent_Robo_Bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "˹𝗦𝗜𝗟𝗘𝗡𝗧 𝗥𝗢𝗕𝗢˼🫧")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "Silent_Smile_04")
EVALOP = list(map(int, getenv("EVALOP", "5278339583").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002053344421))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Silentsmile29/HAZEL_MUSIC-X-BOT",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/3ed81ef4e352a691fb0b4.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/b21cb521c304e52a32187.jpg"
)
