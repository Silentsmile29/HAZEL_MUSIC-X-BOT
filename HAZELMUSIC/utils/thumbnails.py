...
async def get_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("HAZELMUSIC/assets/thumb/circle.png")
            ...
            # fonts
            font1 = ImageFont.truetype('HAZELMUSIC/assets/thumb/font.ttf', 30)
            font2 = ImageFont.truetype('HAZELMUSIC/assets/thumb/font2.ttf', 70)
            font3 = ImageFont.truetype('HAZELMUSIC/assets/thumb/font2.ttf', 40)
            font4 = ImageFont.truetype('HAZELMUSIC/assets/thumb/font2.ttf', 35)
