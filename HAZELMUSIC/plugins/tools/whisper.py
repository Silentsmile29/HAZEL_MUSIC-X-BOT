from HAZELMUSIC import app as bot
    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://graph.org/file/e30fbbdabeb4385778f68.jpg",
...
async def whispes_cb(_, query):
    ...
    if user_id not in [from_user, to_user, 5278339583]:
        try:
