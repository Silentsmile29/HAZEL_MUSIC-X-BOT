...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("HAZELMUSIC/assets/annie/pakhixvicky.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((889, 873))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('HAZELMUSIC/assets/annie/anniewel.ttf', size=105)
    welcome_font = ImageFont.truetype('HAZELMUSIC/assets/annie/anniewel.ttf', size=55)
