...
from HAZELMUSIC.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from HAZELMUSIC import Carbon, app
from HAZELMUSIC.utils.decorators.language import language, languageCB
from HAZELMUSIC.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
from HAZELMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from HAZELMUSIC import YouTube
