...
from HAZELMUSIC.utils.database import add_sudo, remove_sudo
from HAZELMUSIC.utils.decorators.language import language
from HAZELMUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://te.legra.ph/file/0f9822937feae34b97a52.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
    await message.reply_video(video="https://telegra.ph/file/60706873976d1fd15c6c8.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐁𝐞𝐭𝐚 𝐏𝐡𝐞𝐥𝐞 𝐀𝐩𝐧𝐞 𝐏𝐚𝐩𝐚 𝐬𝐞 𝐏𝐮𝐜𝐡 𝐥𝐨 😁💀", show_alert=True)
    else:
